 ...
 * reports a change whose facts are nearly all accurate and nearly all beneath the reader's notice, the rule reaches
 * the drafter as a license to keep them. It states its own rule instead, in "What to leave out".
 */
