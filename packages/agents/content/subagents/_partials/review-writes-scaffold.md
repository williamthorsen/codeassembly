...
Write exactly this structure. The YAML frontmatter is part of the scaffold so that partial writes are parseable too; see [Frontmatter](#frontmatter) for field resolution.
