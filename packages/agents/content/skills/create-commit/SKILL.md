...
5. **Compose the body.** The conventions carry its voice and its mechanics; [Line breaks](#line-breaks) below states the one mechanic that binds only while the body is being written.
