...
- **Confirm first only when the fix is genuinely ambiguous** (more than one reasonable reading of what to change) **or risky, large, or hard to reverse.** Then state the change that you intend to make and wait for a go-ahead before applying.
