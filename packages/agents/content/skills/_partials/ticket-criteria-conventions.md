...
**Umbrella criterion convention:** An umbrella ticket, whose children carry the work, lists "Every child is closed" as an acceptance criterion alongside any requirement of its own, so what completes it is stated rather than inferred.
