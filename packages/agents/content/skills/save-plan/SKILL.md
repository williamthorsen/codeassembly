...
Save the plan from the current conversation as a ticket-scoped artifact. Useful after built-in plan mode, `{skill:plan}`, or any conversation that produced a plan.
