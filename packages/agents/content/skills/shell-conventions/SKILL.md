...
description: Use when writing, reviewing, or modifying bash shell scripts. Covers script structure, help/exit-code behavior, argument parsing, error handling, and the shared functions/ library.
