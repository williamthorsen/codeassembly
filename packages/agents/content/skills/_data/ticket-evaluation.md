...
A ticket — regardless of who created it — is a request, report, or suggestion, not a contract. We own the code; the ticket is input. Any behavioral or API change it proposes is a recommendation to evaluate, not an instruction to implement.
