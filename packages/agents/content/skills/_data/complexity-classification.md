...
| `next-steps-after-plan`            | 1–2       | Recommend "Implement directly"; rule 2 broadens beyond strict levels 1–2 when the verification surface fits a single review pass |
