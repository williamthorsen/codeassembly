...
| `next-steps-after-review`          | 1–2    | Recommend "Implement directly" — the findings are trivial enough for the reviewer to fix in place rather than hand off to the author.                                                                   |
