...
| `next-steps-after-review`          | —      | Trivial findings are usually determinate, which is what selects "Implement directly"; the recommendation turns on determinacy rather than on the level.                                                 |
