...
At session start, resolve the pull-request URL on which a skill operates, and reuse it across sessions. Skills that act on "the PR for this branch" should use this shared resolution logic.
