...
Intros, hedging, restated context, exhaustive enumeration. Process narration (how the work or decision was reached) when only the conclusion serves the reader.

## Self-test

For each sentence, ask: Would removing it change what the reader does, or must know to act? If not, cut it. Run this before presenting, not after a reader complains.
