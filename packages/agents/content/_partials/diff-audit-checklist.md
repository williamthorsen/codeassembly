...
- **Class.** When the change corrects a defect, the site you were pointed at is a sample of its class. Audit the other members before reporting, or the next reviewer finds the one that you left.
