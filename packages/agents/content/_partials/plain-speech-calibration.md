...
Passive voice is not a defect on its own, and case 3 is no licence to convert it. Keep the passive where the actor is obvious or beside the point, where the patient is the paragraph's topic, or where it puts a long phrase at the end of the sentence.
...
- A figure whose meaning the literal phrase drops. The rule's own "a figure drags in connotations" is one: "drags in" says the figure brings the connotations with it and that they are hard to remove, where "has" reports only that they exist. Leave any figure doing comparable work.
...
8. **A concrete metaphor standing in for the literal abstraction.** The inverse of shape 7. "attrition rather than advocacy" becomes "tiring the developer rather than persuading them". "priced on your ledger" becomes "a cost to you".
