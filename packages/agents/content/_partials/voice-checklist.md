...
- **Altitude.** Every sentence sits at the accomplishment level. A finding established during the work, a count of instances touched, an internal causal chain, and the before-and-after syntax of an edit sit below it.
- **Deletion.** Nothing here also stands in `## Details`. Where it does, cut it from the lede; where the fact lives nowhere else, move it down.
...
- **Register.** Every verb is the plain one, and no sentence makes an event the actor in place of the thing that acts.
