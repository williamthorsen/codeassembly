...
- **Names.** Every package, command, flag, file, or rule that this reader consumes is named and backticked. Which ones qualify turns on the reader: An internal module is mechanism for the user and the subject for the contributor.
