...
/** The token standing in an inline code span's place, which is what a reported phrase contains where a span stood. */
...
/**
 * Replaces every inline code span in `text` with {@link CODE_SPAN_PLACEHOLDER}. The newlines covered by a span are
