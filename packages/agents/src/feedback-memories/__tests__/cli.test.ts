...
describe(runFeedbackMemories, () => {
  ...
  it('treats empty stdin for delete as a clean no-op', async () => {
    const result = await runFeedbackMemories({ argv: ['delete'], stdin: bodyStream('   \n'), env: {} });
  ...
  it('returns invalid-args for an unknown subcommand', async () => {
    const result = await runFeedbackMemories({ argv: ['frobnicate'], stdin: bodyStream(''), env: {} });
  ...
  it('returns invalid-args when no subcommand is given', async () => {
    const result = await runFeedbackMemories({ argv: [], stdin: bodyStream(''), env: {} });
  ...
  it('returns invalid-args when enumerate is given a stray argument', async () => {
    const result = await runFeedbackMemories({ argv: ['enumerate', 'extra'], stdin: bodyStream(''), env: {} });
  ...
  it('returns invalid-args when --store has no value', async () => {
    const result = await runFeedbackMemories({ argv: ['enumerate', '--store'], stdin: bodyStream(''), env: {} });
