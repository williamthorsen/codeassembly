 ...
 * first-occurrence order. An empty list is a valid result (it clears the tags). No timestamp is stamped: retagging is
 * a curatorial edit, and events are write-once.
 */
