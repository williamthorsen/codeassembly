 ...
 * keeps the marker, and `breaking` sets the marker in the direction it names. Every field the overrides do not name,
 * and every field outside the scope, type, and marker, keeps the record's value.
 */
