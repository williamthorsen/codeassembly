 ...
 *
 * A record violates by setting the marker when its type's policy forbids it, and by omitting it when that policy
 * requires it. A record naming a type not declared by the taxonomy has no policy to break.
 */
