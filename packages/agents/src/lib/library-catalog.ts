 ...
 * here", which is the pair that `isMissingFile` covers.
 */
...
/**
 * Lists the visible subdirectories of `skillsDir` that are skill directories. Visibility separates this from
