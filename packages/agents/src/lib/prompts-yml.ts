...
/**
 * The line with which the `prompts.yml` region opens, so that a reader knows an entry added inside it is lost on the
 * next sync.
 */
 ...
 * when the directory is absent. The projection on which the region renderer builds.
 */
