...
/** The note with which the region body opens, stated here rather than imported, so that the test pins the wording. */
...
describe(renderPromptEntries, () => {
  ...
  it('opens with the generated note above the entries, headerless, with a trailing newline', () => {
    expect(
      renderPromptEntries([
        { name: 'alpha', description: 'Alpha desc', contentFile: 'skills/alpha/SKILL.md' },
        { name: 'beta', description: 'Beta does things', contentFile: 'skills/beta/SKILL.md' },
