...
// The bundled default knowledge-base schema. Its `types` are the four Diátaxis modes; its `required` and `optional`
// field sets are the canonical vault frontmatter conventions.
//
